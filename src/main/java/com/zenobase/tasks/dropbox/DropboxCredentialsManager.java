...
public class DropboxCredentialsManager extends OAuthCredentialsManager {
	...
	@Inject
	public DropboxCredentialsManager(CredentialsRepository repository, @Named("dropbox.api.key") String apiKey, @Named("dropbox.api.secret") String apiSecret, @Named("oauth.hostname") String callbackUrl) {
