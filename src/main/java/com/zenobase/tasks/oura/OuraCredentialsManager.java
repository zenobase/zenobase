...
public class OuraCredentialsManager extends OAuthCredentialsManager {

	private static final Logger logger = LoggerFactory.getLogger(OuraCredentialsManager.class);

	public static final String TYPE = "oura";

	@Inject
	public OuraCredentialsManager(CredentialsRepository integrations, @Named("oura.api.key") String apiKey, @Named("oura.api.secret") String apiSecret, @Named("oauth.hostname") String callbackUrl) {
