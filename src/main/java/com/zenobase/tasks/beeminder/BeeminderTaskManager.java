...
public class BeeminderTaskManager extends OAuthTaskManager {
	...
	private static final Logger logger = LoggerFactory.getLogger(BeeminderTaskManager.class);
	...
	public Task newTask(String bucketId, Identity principal, ObjectNode settings) {
		...
		String keyField = MoreObjects.firstNonNull(settings.path("key_field").textValue(), Event.TIMESTAMP.getName());
