...
abstract class GoogleFitResultSupport {
	...
	private static final ImmutableMap<String, Resource> SOURCES = ImmutableMap.<String, Resource>builder()
		...
		.put(
			...
			new Resource("Heart Rate Plus", "https://play.google.com/store/apps/details?id=com.dungelin.heartrate")
		)
		...
		.put(
			...
			new Resource("Push Ups Workout", "https://play.google.com/store/apps/details?id=com.northpark.pushups")
		)
		.put(
			"com.popularapp.sevenmins",
			new Resource("7 Minute Workout", "https://play.google.com/store/apps/details?id=com.popularapp.sevenmins")
		)
		...
		.put(
			...
			new Resource("HeartSync", "https://play.google.com/store/apps/details?id=com.ryansteckler.heartsync")
		)
		.put(
