...
public class HexoskinActivitiesResultTest extends ResultTestSupport {
	...
	public void test() {
		...
		assertThat(events.get(0).getValues(Event.TIMESTAMP))
				.containsExactly(dateTime("2013-07-31T15:03:42-07:00"), dateTime("2013-07-31T16:44:37-07:00"));
		...
		assertThat(events.get(0).getValue(Event.RESOURCE))
				.isEqualTo(new Resource("Free program", "https://my.hexoskin.com/en/activities/26879"));
