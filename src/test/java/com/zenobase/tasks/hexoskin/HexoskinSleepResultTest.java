...
public class HexoskinSleepResultTest extends ResultTestSupport {
	...
	public void test() {
		...
		assertThat(events.get(0).getValues(Event.TIMESTAMP))
				.containsExactly(dateTime("2014-03-26T03:56:00-07:00"), dateTime("2014-03-27T00:00:00-07:00"));
		...
		assertThat(events.get(0).getValue(Event.RESOURCE))
				.isEqualTo(new Resource("Sleep", "https://my.hexoskin.com/en/activities/37441"));
