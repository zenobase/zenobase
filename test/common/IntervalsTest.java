...
public class IntervalsTest {
	...
	public void testForYear() {
		Interval year = Intervals.valueOf("2012", DateTimeZone.UTC);
	...
	public void testForMonth() {
		Interval month = Intervals.valueOf("2012-01", DateTimeZone.UTC);
	...
	public void testForDay() {
		Interval day = Intervals.valueOf("2012-01-01", DateTimeZone.UTC);
	...
	public void testForHour() {
		Interval day = Intervals.valueOf("2012-01-01T14", DateTimeZone.UTC);
	...
	public void testForHourPST() {
		Interval day = Intervals.valueOf("2012-01-01T14", DateTimeZone.forOffsetHours(-8));
