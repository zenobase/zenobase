	...
	public void test() {
		running(testServer(PORT), new Runnable() {
			...
			public void run() {
				...
				assertThat($("#permissions-dialog-link-private")).isDisplayed();
				assertThat($("#permissions-dialog-link-public")).isNotDisplayed();
				$("#permissions-dialog-link-private").click();
				assertThat($("#permissions-dialog")).isDisplayed();
				$("#publish-link").click();
				$("#update-permissions-button").click();
				assertThat($("#permissions-dialog")).isNotDisplayed();
				assertThat($("#permissions-dialog-link-private")).isNotDisplayed();
				assertThat($("#permissions-dialog-link-public")).isDisplayed();
