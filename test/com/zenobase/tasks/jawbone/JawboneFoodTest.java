...
public class JawboneFoodTest extends TaskTestSupport {

	@Test
	public void test() {
		JawboneFoodTaskManager manager = new JawboneFoodTaskManager(newCredentialsManager());
		ObjectNode settings = Nodes.newObject();
		settings.put("tag", "Meal");
