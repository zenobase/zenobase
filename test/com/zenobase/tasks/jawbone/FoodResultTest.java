...
public class FoodResultTest extends ResultTestSupport {
	...
	public void test() {
		...
		meal1.setValue(Event.TIMESTAMP, dateTime("20141016T093537-07:00"));
		meal1.addValue(Event.TAG, "Meal");
		meal1.setValue(Event.ENERGY, Measures.<Energy>valueOf("224 kcal"));
		...
		meal2.setValue(Event.TIMESTAMP, dateTime("20141016T124827-07:00"));
		meal2.addValue(Event.TAG, "Meal");
		meal2.setValue(Event.ENERGY, Measures.<Energy>valueOf("460 kcal"));
