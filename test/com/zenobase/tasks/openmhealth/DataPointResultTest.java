...
public class DataPointResultTest extends ResultTestSupport {
	...
	public void testComplete() {
		...
		expected.setValue(Event.AUTHOR, TESTER);
		expected.setValue(Event.SOURCE, DataPointResult.SOURCE);
		expected.addValue(Event.CONCENTRATION, DecimalMeasure.<VolumetricDensity>valueOf("120 mg/dL"));
		expected.addValue(Event.PRESSURE, DecimalMeasure.<Pressure>valueOf("160 mmHg"));
		expected.addValue(Event.PRESSURE, DecimalMeasure.<Pressure>valueOf("60 mmHg"));
		expected.addValue(Event.TEMPERATURE, DecimalMeasure.<Temperature>valueOf("97 F"));
		expected.addValue(Event.PERCENTAGE, Percentage.valueOf(16));
		expected.addValue(Event.HEIGHT, DecimalMeasure.<Length>valueOf("180 cm"));
		expected.addValue(Event.WEIGHT, DecimalMeasure.<Mass>valueOf("50 kg"));
		expected.addValue(Event.ENERGY, DecimalMeasure.<Energy>valueOf("160 kcal"));
		expected.addValue(Event.FREQUENCY, DecimalMeasure.<Frequency>valueOf("50 bpm"));
		expected.addValue(Event.DISTANCE, DecimalMeasure.<Length>valueOf("3.1 mi"));
