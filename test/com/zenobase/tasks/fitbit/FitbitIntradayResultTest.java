...
public class FitbitIntradayResultTest extends ResultTestSupport {
	...
	public void test() {
		List<Interval> ignore = Lists.newArrayList(
			new Interval(dateTime("2012-12-03T00:30:05-08:00"), dateTime("2012-12-03T08:25:00-08:00")),
			new Interval(dateTime("2012-12-03T23:00:00-08:00"), dateTime("2012-12-04T08:00:00-08:00"))
		);
		...
		first.setValue(Event.TIMESTAMP, dateTime("2012-12-03T00:00:00-08:00"));
		...
		second.setValue(Event.TIMESTAMP, dateTime("2012-12-03T08:25:00-08:00"));
