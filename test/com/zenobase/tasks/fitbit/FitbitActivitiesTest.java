...
public class FitbitActivitiesTest extends TaskTestSupport {

	@Test
	public void test() {
		FitbitActivitiesTaskManager manager = new FitbitActivitiesTaskManager(newCredentialsManager());
		ObjectNode settings = Nodes.newObject();
		settings.put("marker", "2014-10-25");
