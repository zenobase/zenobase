...
public class FitbitActivitiesLegacyResultTest extends ResultTestSupport {

	@Test
	public void test() {

		FitbitActivitiesLegacyResult result = new FitbitActivitiesLegacyResult(readObject("FitbitActivitiesLegacyResultTest.json"), TESTER, DateTimeZone.forID("America/Los_Angeles"), Units.MI);
