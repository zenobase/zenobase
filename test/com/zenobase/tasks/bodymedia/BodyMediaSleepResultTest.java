...
public class BodyMediaSleepResultTest extends ResultTestSupport {
	...
	public void testGainOneHour() {
		...
		assertEvent(events.get(0), "2013-11-03T00:14:00-0700", 534, 79);
		assertEvent(events.get(1), "2013-11-03T08:13:00-0800", 35, 6);
	}
	...
	public void testLoseOneHour() {
		...
		assertEvent(events.get(0), "2013-03-09T23:58:00.000-08:00", 486, 84);
	}
	...
	private BodyMediaSleepResult parse(String source) {
		return new BodyMediaSleepResult(readObject(source), author, timezones);
	}

	private static void assertEvent(Event event, String timestamp, int minutes, int rating) {
