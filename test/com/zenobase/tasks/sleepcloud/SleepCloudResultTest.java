...
public class SleepCloudResultTest extends ResultTestSupport {
	...
	public void test() {
		...
		e1.setValue(Event.SOURCE, SleepCloudResult.SOURCE);
		...
		e1.setValue(Event.NOTE, "just testing...");
		...
		e2.setValue(Event.SOURCE, SleepCloudResult.SOURCE);
		...
		e3.setValue(Event.SOURCE, SleepCloudResult.SOURCE);
