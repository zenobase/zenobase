...
public class DatasetResultTest extends ResultTestSupport {
	...
	public void test() {
		...
		assertThat(points.get(0).getBegin()).isEqualTo(dateTime("2014-10-29T00:17:46.474-07:00"));
		assertThat(points.get(0).getEnd()).isEqualTo(dateTime("2014-10-29T00:20:42.474-07:00"));
		assertThat(points.get(0).getDataType()).isEqualTo("com.google.step_count.delta");
		assertThat(points.get(0).getValue(0)).isEqualTo(new BigDecimal(88));

		assertThat(points.get(1).getBegin()).isEqualTo(dateTime("2014-10-29T09:31:45.945-07:00"));
		assertThat(points.get(1).getEnd()).isEqualTo(dateTime("2014-10-29T09:32:45.946-07:00"));
		assertThat(points.get(1).getDataType()).isEqualTo("com.google.step_count.delta");
		assertThat(points.get(1).getValue(0)).isEqualTo(new BigDecimal(30));
	}
