...
public class ActivitiesResultTest extends ResultTestSupport {
	...
	public void test() {
		...
		ActivitiesResult result = new ActivitiesResult(TESTER, begin, readArray("ActivitiesResultTest.json"));
		...
		expected.setValue(Event.DISTANCE, Measures.<Length>valueOf("1251 m"));
