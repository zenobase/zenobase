...
public class GanttWidgetTest extends SearchTestSupport {
	...
	public void setUp() {
		super.setUp();
		e1 = newEvent("t1", new DateTime(2012, 3, 31, 20, 15, 30, DateTimeZone.UTC));
		e2 = newEvent("t1", new DateTime(2012, 5, 15, 8, 30, 00, DateTimeZone.UTC));
		e3 = newEvent("t2", new DateTime(2012, 5, 15, 8, 30, 00, DateTimeZone.UTC));
		e4 = newEvent("t2", null);
		e5 = newEvent("t3", null);
	}

	private static Event newEvent(String tag, DateTime timestamp) {
	...
	public void testDefault() {
		...
		addEvent(e4);
		addEvent(e5);
		addWidget("id:%s,type:%s,field:%s", id, GanttWidget.TYPE, Event.TAG);
