...
public class MovesCredentialsManager extends OAuthCredentialsManager {

	private static final String TYPE = "moves";

	@Inject
	public MovesCredentialsManager(CredentialsRepository repository, @Named("moves.api.key") String apiKey, @Named("moves.api.secret") String apiSecret, @Named("oauth.hostname") String callbackUrl) {
		super(TYPE, repository, new MovesApi(), apiKey, apiSecret, callbackUrl);
	}
	...
	private void reauthorize(OAuthCredentials credentials) {
		OAuthRequest request = new OAuthRequest(Verb.POST, "https://api.moves-app.com/oauth/v1/access_token");
