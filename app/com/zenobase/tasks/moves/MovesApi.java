...
public class MovesApi extends DefaultApi20 {
	...
	private static final String AUTHORIZATION_URL = "https://api.moves-app.com/oauth/v1/authorize?response_type=code&client_id=%s&redirect_uri=%s&scope=activity location";
