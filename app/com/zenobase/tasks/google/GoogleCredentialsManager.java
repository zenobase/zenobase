...
public class GoogleCredentialsManager extends OAuthCredentialsManager {
	...
	@Inject
	public GoogleCredentialsManager(CredentialsRepository integrations, @Named("google.api.key") String apiKey, @Named("google.api.secret") String apiSecret, @Named("oauth.hostname") String callbackUrl) {
