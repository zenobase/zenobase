...
public class RescueTimeApi extends DefaultApi20 {
	...
	private static final String AUTHORIZATION_URL = "https://www.rescuetime.com/oauth/authorize?response_type=code&client_id=%s&redirect_uri=%s";

	@Override
	public String getAccessTokenEndpoint() {
		return "https://www.rescuetime.com/oauth/token";
	}
