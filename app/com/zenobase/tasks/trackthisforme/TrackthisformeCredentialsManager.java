...
public class TrackthisformeCredentialsManager extends OAuthCredentialsManager {

	public static final String TYPE = "trackthisforme";

	@Inject
	public TrackthisformeCredentialsManager(CredentialsRepository integrations, @Named("trackthisforme.api.key") String apiKey, @Named("trackthisforme.api.secret") String apiSecret, @Named("oauth.hostname") String callbackUrl) {
		super(TYPE, integrations, new TrackthisformeApi(), apiKey, apiSecret, callbackUrl);
	}
