...
public class MisfitCredentialsManager extends OAuthCredentialsManager {

	public static final String TYPE = "misfit";

	@Inject
	public MisfitCredentialsManager(CredentialsRepository integrations, @Named("misfit.api.key") String apiKey, @Named("misfit.api.secret") String apiSecret, @Named("oauth.hostname") String callbackUrl) {
		super(TYPE, integrations, new MisfitApi(), apiKey, apiSecret, callbackUrl);
	}
	...
	public void sign(OAuthRequest request, OAuthCredentials credentials) {
		request.addHeader("access_token", credentials.getToken().getToken());
	}
}
