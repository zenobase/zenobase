...
public class JawboneCredentialsManager extends OAuthCredentialsManager {

	public static final String TYPE = "jawbone";

	@Inject
	public JawboneCredentialsManager(CredentialsRepository integrations, @Named("jawbone.api.key") String apiKey, @Named("jawbone.api.secret") String apiSecret, @Named("oauth.hostname") String callbackUrl) {
		super(TYPE, integrations, new JawboneApi(), apiKey, apiSecret, callbackUrl);
	}
	...
	private void reauthorize(OAuthCredentials credentials) {
		OAuthRequest request = new OAuthRequest(Verb.POST, "https://jawbone.com/auth/oauth2/token");
