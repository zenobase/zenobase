...
import com.zenobase.tasks.withings.WithingsHealthCardioTaskManager;
import com.zenobase.tasks.withings.WithingsHealthCredentialsManager;
import com.zenobase.tasks.withings.WithingsHealthSleepTaskManager;
import com.zenobase.tasks.withings.WithingsHealthStepsTaskManager;
import com.zenobase.tasks.withings.WithingsHealthWeightTaskManager;
	...
	private void createInjector() {
		injector = Guice.createInjector(new AbstractModule() {
			...
			protected void configure() {
				...
				bindIfConfigured("withings", WithingsHealthCredentialsManager.class, credentials);
				...
				bindIfConfigured("withings", WithingsHealthCardioTaskManager.class, tasks);
				bindIfConfigured("withings", WithingsHealthStepsTaskManager.class, tasks);
				bindIfConfigured("withings", WithingsHealthWeightTaskManager.class, tasks);
				bindIfConfigured("withings", WithingsHealthSleepTaskManager.class, tasks);
